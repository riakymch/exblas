...
double exsum(int N, double *a, int inca, int fpe, bool early_exit) {
    ...
    if (fpe == 2)
        return (ExSUMFPE<FPExpansionVect<Vec8d, 2> >)(N, a, inca);

    if (early_exit) {
        if (fpe == 3)
            return (ExSUMFPE<FPExpansionVect<Vec8d, 3, true > >)(N, a, inca);
        if (fpe == 4)
            return (ExSUMFPE<FPExpansionVect<Vec8d, 4, true > >)(N, a, inca);
        if (fpe == 5)
            return (ExSUMFPE<FPExpansionVect<Vec8d, 5, true > >)(N, a, inca);
        if (fpe == 6)
            return (ExSUMFPE<FPExpansionVect<Vec8d, 6, true > >)(N, a, inca);
        if (fpe == 7)
            return (ExSUMFPE<FPExpansionVect<Vec8d, 7, true > >)(N, a, inca);
        if (fpe == 8)
            return (ExSUMFPE<FPExpansionVect<Vec8d, 8, true > >)(N, a, inca);
    } else { // ! early_exit
        if (fpe == 3)
            return (ExSUMFPE<FPExpansionVect<Vec8d, 3> >)(N, a, inca);
        if (fpe == 4)
            return (ExSUMFPE<FPExpansionVect<Vec8d, 4> >)(N, a, inca);
        if (fpe == 5)
            return (ExSUMFPE<FPExpansionVect<Vec8d, 5> >)(N, a, inca);
        if (fpe == 6)
            return (ExSUMFPE<FPExpansionVect<Vec8d, 6> >)(N, a, inca);
        if (fpe == 7)
            return (ExSUMFPE<FPExpansionVect<Vec8d, 7> >)(N, a, inca);
        if (fpe == 8)
            return (ExSUMFPE<FPExpansionVect<Vec8d, 8> >)(N, a, inca);
    }

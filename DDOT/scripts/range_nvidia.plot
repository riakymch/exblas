...
set logscale x 10
set yrange [0:]
set output "| epstopdf --filter > ../imgs/InputRange.VS.GBs.NVIDIA.2014.04.29.Round.2.pdf"
...
plot "../results/InputRange.VS.GBs.NVIDIA.2014.04.29.Round.gnuplot.dat" using (2**$1):($2) with lines lt 4 lw 4.0 title "Parallel DDOT", \

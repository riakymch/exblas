...
extern "C" size_t DGEMMNVIDIA(
    ...
    {
        size_t NbThreadsPerWorkGroup[] = {(size_t) (BM), (size_t) (BM)};
        size_t TotalNbThreads[] = {(size_t) (d_C.height / BM), (size_t) (d_C.width / BN)};
        size_t neededLocalMemory = BK * BN * sizeof(cl_double);

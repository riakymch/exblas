...
set logscale x 10
set yrange [0:25]
set output "| epstopdf --filter > ../imgs/exsum.range.mic.15.09.11.pdf"
...
plot "../results/exsum.range.mic.15.09.11.txt" using (2**$2):(1.053/$3) with lines lt 1 lw 4.0 title "Superacc", \

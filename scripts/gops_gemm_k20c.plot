...
set xrange [0:]
set yrange [0:]
set output "| epstopdf --filter > ../imgs/exgemm.gops.k20c.15.09.21.short.yes.no.yes.yes.pdf"
...
plot "../results/exgemm.gops.k20c.15.09.21.short.yes.no.yes.yes.txt" using 1:($5) with lines lt 1 lw 4.0 title "Superacc", \
